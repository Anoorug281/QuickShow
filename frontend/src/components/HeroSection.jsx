    ...
    <>
        ...
        lg:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
            ...
            <p className='max-w-md text-gray-300'>
                ...
                consume each other to survive, two people meet in London and try to stop
                a conspiracy.
            </p>
            <button onClick={()=> {navigate('/movies'); scrollTo(0,0)}} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary
