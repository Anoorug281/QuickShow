...
const Navbar = () => {
  ...
  return (
    ...
    justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      max-md:text-lg rounded-full z-50 flex flex-col md:flex-row items-center justify-center
      gap-8 min-md: px-8 py-3 max-md:h-screen backdrop-blur bg-black/70 
