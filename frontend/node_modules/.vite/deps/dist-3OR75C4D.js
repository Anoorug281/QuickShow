...
var Ct2 = async (e2, t3) => {
  if (t3 === I.MP4) return { streamType: _.ON_DEMAND, targetLiveWindow: Number.NaN, liveEdgeStartOffset: void 0, sessionData: void 0 };
  if (t3 === I.M3U8) {
...
var Gt2 = (e2, t3, r12) => {
  ...
  if (v(t3, "durationchange", u5), t3 && n3) {
    ...
    if (typeof o4 == "string") {
      ...
      let T3 = () => {
        if (Ue2(t3) !== _.LIVE || Number.isFinite(t3.duration)) return;
...
var MediaFullscreenButton = class extends MediaChromeButton {
  constructor() {
    super(...arguments);
    __privateAdd12(this, _lastActionEvent, null);
  }
  static get observedAttributes() {
    return [
      ...super.observedAttributes,
  ...
  handleClick(e2) {
    ...
    const isPointerEvent = __privateGet12(this, _lastActionEvent) instanceof PointerEvent;
...
var MediaTimeRange = class extends MediaChromeRange {
  constructor() {
    ...
    __privateAdd20(this, _isPointerDown, void 0);
    __privateAdd20(this, _updateRange, (value) => {
      ...
      if (!__privateGet20(this, _isPointerDown)) {
        this.updateBar();
      }
    });
  ...
  updateCurrentBox() {
    ...
    const rects = __privateMethod6(this, _getElementRects, getElementRects_fn).call(this, __privateGet20(this, _currentBox));
...
handlePointerMove_fn3 = function(evt) {
  ...
  const rects = __privateMethod6(this, _getElementRects, getElementRects_fn).call(this, __privateGet20(this, _previewBox));
  ...
  __privateMethod6(this, _previewRequest, previewRequest_fn).call(this, __privateGet20(this, _previewTime));
};
...
var MediaThemeElement = class extends GlobalThis.HTMLElement {
  ...
  createRenderer() {
    if (this.template instanceof HTMLTemplateElement && this.template !== __privateGet22(this, _prevTemplate)) {
...
var MediaChromeMenu = class extends GlobalThis.HTMLElement {
  constructor() {
    ...
    __privateAdd23(this, _toggleHeader);
...
render_fn4 = function() {
  if (__privateGet28(this, _prevState3).mediaRenditionList === JSON.stringify(this.mediaRenditionList) && __privateGet28(this, _prevState3).mediaHeight === this.mediaHeight)
    return;
  __privateGet28(this, _prevState3).mediaRenditionList = JSON.stringify(
...
var MediaContextMenu = class extends MediaChromeMenu {
  constructor() {
    super();
    __privateAdd29(this, _updateVisibility);
    __privateAdd29(this, _closeContextMenu);
    __privateAdd29(this, _closeOtherContextMenus);
    __privateAdd29(this, _isVideoContainer);
    __privateAdd29(this, _onContextMenu);
    __privateAdd29(this, _isContextMenuOpen, false);
    __privateAdd29(this, _onControllerContextMenu, (event) => {
      ...
      if (isVideoElement || isVideoContainer) {
        if (!__privateGet29(this, _isContextMenuOpen)) {
    ...
    __privateAdd29(this, _onDocumentClick, (event) => {
      const target = event.target;
    ...
    __privateAdd29(this, _onKeyDown, (event) => {
      if (event.key === "Escape") {
        __privateMethod14(this, _closeContextMenu, closeContextMenu_fn).call(this);
      }
    });
    __privateAdd29(this, _onMenuClick, (event) => {
      var _a4, _b;
      const target = event.target;
  ...
  connectedCallback() {
    ...
    getMediaController(this).addEventListener(
      "contextmenu",
      __privateGet29(this, _onControllerContextMenu)
    );
    this.addEventListener("click", __privateGet29(this, _onMenuClick));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    ...
    this.removeEventListener("click", __privateGet29(this, _onMenuClick));
    document.removeEventListener("mousedown", __privateGet29(this, _onDocumentClick));
    document.removeEventListener("keydown", __privateGet29(this, _onKeyDown));
  }
};
_isContextMenuOpen = /* @__PURE__ */ new WeakMap();
_updateVisibility = /* @__PURE__ */ new WeakSet();
updateVisibility_fn = function() {
  this.hidden = !__privateGet29(this, _isContextMenuOpen);
};
...
onContextMenu_fn = function(event) {
  ...
  __privateMethod14(this, _updateVisibility, updateVisibility_fn).call(this);
  document.addEventListener("mousedown", __privateGet29(this, _onDocumentClick), {
    once: true
  });
  document.addEventListener("keydown", __privateGet29(this, _onKeyDown), { once: true });
};
...
var Ne3 = class extends Ce3 {
  ...
  get poster() {
    ...
    if (this.playbackId && !this.audio) return ot2(this.playbackId, { customDomain: this.customDomain, thumbnailTime: (r12 = this.thumbnailTime) != null ? r12 : this.startTime, programTime: this.programStartTime, token: i2.thumbnail });
  }
  set poster(e2) {
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-3OR75C4D.js.map
